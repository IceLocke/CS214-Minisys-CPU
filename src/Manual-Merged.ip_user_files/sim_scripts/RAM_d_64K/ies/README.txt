...
#
# Generated by export_simulation on Fri May 26 11:08:59 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './RAM_d_64K.sh' script.

./RAM_d_64K.sh -reset_run
...
./RAM_d_64K.sh -noclean_files

For more information on the script, please type './RAM_d_64K.sh -help'.

...
HD_PWD='C:/Users/11432/Desktop/CS214tool/CS214-Minisys-CPU/src/CS214-Minisys-CPU.runs/uartbmpg_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uartbmpg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uartbmpg.tcl
